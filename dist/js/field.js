...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('flexible-drop-menu', __webpack_require__(27));
    Vue.component('flexible-search-menu', __webpack_require__(30));
...
var strip_tags = __webpack_require__(24);
var truncate = __webpack_require__(25);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    title: function title() {
      var label = null;
      for (var f = 0; f < this.group.fields.length; f++) {
        switch (this.group.fields[f].name) {
          ...
          case "Sound":
          case "Stat":
            for (var o in this.group.fields[f].options) {
              if (this.group.fields[f].value == this.group.fields[f].options[o].value) {
                label = this.group.fields[f].options[o].label;
              }
            }
            break;
        }
      ...
      return label ? truncate(strip_tags(label), 60) || "New" : this.group.title;
    },
    titleStyle: function titleStyle() {
